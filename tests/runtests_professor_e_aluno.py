...
class TestAlunoEndpoints(unittest.TestCase):
    ...
    def test_001_adiciona_alunos(self):
        ...
        response_fernando = requests.post('http://127.0.0.1:8000/alunos', data={
            'nome': 'Fernando',
            'idade': 20,
            'turma_id': 1,
    ...
    def test_004_professor_deletado_com_sucesso(self):
        ...
        res = requests.get('http://127.0.0.1:8000/professor')
        self.assertEqual(
    ...
    def test_005_adicionar_professor(self):
        res = requests.get('http://127.0.0.1:8000/professores/novo')
    ...
    def test_006a_id_inexistente_no_put(self):
        id_aluno = 999
        r = requests.post(f'http://localhost:8000/alunos/{id_aluno}/atualizar',
                          data={'nome': 'bowser'})
    ...
    def test_006b_id_inexistente_no_get(self):
        id_aluno = 999
        r = requests.get(f'http://localhost:8000/alunos/{id_aluno}')
        self.assertEqual(r.status_code, 404)
    ...
    def test_006c_id_inexistente_no_delete(self):
        id_aluno = 999
        r = requests.post(f'http://localhost:8000/alunos/{id_aluno}',
                          data={'_method': 'DELETE'})
        self.assertEqual(r.status_code, 404)
        json_response = r.json() if r.content else None
        self.assertIsNotNone(json_response)
    ...
    def test_008a_post_sem_nome(self):
        ...
        r = requests.post('http://127.0.0.1:8000/alunos', data={
    ...
    def test_008b_put_sem_nome(self):
        ...
        r = requests.post('http://127.0.0.1:8000/alunos/7/atualizar', data={
            'id': 7,
            'idade': 21,
            'turma_id': 1,
            'data_nascimento': '2000-01-01',
